...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section bg-light/50 dark:bg-dark/50 relative">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-white dark:bg-dark/80 p-3 rounded-lg shadow-md mr-4">
          ...
          <div className="bg-white dark:bg-dark/80 rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-primary dark:bg-dark/50"
                  required
                />
              </div>
