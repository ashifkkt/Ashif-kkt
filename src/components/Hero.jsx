      ...
      <div className="container relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="mt-12 flex space-x-6 animate-fadeIn delay-600">
            <a href="https://github.com/ashifkkt" target="_blank" rel="noopener noreferrer" className="text-dark/70 dark:text-light/70 hover:text-primary transition-colors">
            ...
            <a href="https://www.linkedin.com/in/ashif-kkt" target="_blank" rel="noopener noreferrer" className="text-dark/70 dark:text-light/70 hover:text-primary transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
